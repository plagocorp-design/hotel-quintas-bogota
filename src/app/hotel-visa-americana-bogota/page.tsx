...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hotelquintasdebogota.com/hotel-visa-americana-bogota" },
  openGraph: {
    title: "Hotel Visa Americana Bogotá | 7 Min de la Embajada",
    description: "El mejor hotel para visa americana. 7 min de la Embajada, desayuno incluido.",
    url: "https://hotelquintasdebogota.com/hotel-visa-americana-bogota",
...
export default function HotelVisaAmericanaPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hotel Visa Americana Bogotá", item: "https://hotelquintasdebogota.com/hotel-visa-americana-bogota" },
    ],
  };
  const hotelJsonLd = {
    "@context": "https://schema.org",
