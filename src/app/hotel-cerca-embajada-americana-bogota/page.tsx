...
export const metadata: Metadata = {
  title: "Hotel Cerca Embajada Americana Bogotá - A 5 Min a Pie | Quintas",
  description: "¿Cita para visa USA? Duerme a 5 min a pie de la Embajada. Hotel Quintas 9.5 en ubicación, desayuno 5am y tranquilidad. 470+ reseñas 8.8. ¡Reserva directa!",
  ...
  openGraph: {
    title: "Hotel a 5 Min de la Embajada Americana - Hotel Quintas",
    description: "A 400 metros de la Embajada USA. Desayuno 5am, guarda-equipaje y tranquilidad total. 8.8 Fabuloso.",
    type: "website",
  },
};
...
export default function EmbajadaPage() {
  const faqJsonLd = {
    ...
    "@type": "FAQPage",
    mainEntity: [
      { "@type": "Question", name: "¿A qué distancia está de la Embajada Americana?", acceptedAnswer: { "@type": "Answer", text: "A 400 metros, 5 minutos a pie de la entrada de la Embajada en la Carrera 45 con Calle 26. Puedes ir caminando sin taxi." } },
      { "@type": "Question", name: "¿Dan desayuno antes de mi cita de las 7am?", acceptedAnswer: { "@type": "Answer", text: "Sí, con aviso previo servimos desayuno desde las 5am y guardamos tu celular y equipaje gratis, ya que no te dejan entrar con ellos." } },
      { "@type": "Question", name: "¿A qué hora debo llegar a mi cita?", acceptedAnswer: { "@type": "Answer", text: "30 minutos antes. Al estar a 5 min, puedes salir 6:30 para cita de 7am sin estrés de tráfico." } },
    ],
  };
    ...
    <>
      ...
      <section className="bg-[#1A2B4A] text-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="text-[#C9A86A] text-sm font-semibold tracking-widest">A 5 MIN A PIE · 9.5 EN UBICACIÓN · 8.8 FABULOSO</div>
            <h1 className="font-serif text-4xl font-bold leading-tight mt-2">Hotel para Cita de Visa Americana en Bogotá: A 5 Min a Pie de la Embajada</h1>
            <p className="mt-4 text-white/80">En Cl. 22 Bis #44A-19, Teusaquillo. Duerme tranquilo, desayuna a las 5am y llega caminando a tu entrevista. Más de 470 huéspedes nos eligen por eso.</p>
            <div className="mt-6 flex gap-3">
              <Link href="/reservas?roomType=doble"><Button variant="gold" size="lg">Verifica tu fecha de cita</Button></Link>
              <a href={hotel.whatsappUrl("Hola, tengo cita en la Embajada el... ¿tienen disponibilidad a 5 min?")} target="_blank"><Button variant="outline" size="lg" className="bg-white text-[#1A2B4A]">WhatsApp 317 6760460</Button></a>
            </div>
          </div>
          <Card className="p-6 bg-white text-[#1A2B4A]">
            <div className="font-semibold">¿Por qué a 5 min te da tranquilidad?</div>
            <ul className="mt-3 space-y-2 text-sm list-disc pl-5">
              <li>Sales 6:30 para cita de 7am, sin trancones de la Calle 26</li>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 space-y-10">
        <section>
          <h2 className="font-serif text-3xl font-bold">¿Por qué dormir a 5 min te da ventaja para tu entrevista?</h2>
        ...
        <section className="grid md:grid-cols-2 gap-6">
          <Card className="p-6">
            ...
            <div className="mt-3 text-sm space-y-2">
              ...
              <div className="bg-[#F5F1E8] p-3 rounded-xl">Llega 30 min antes. Al estar a 5 min, sales 6:30 para cita de 7am.</div>
            </div>
          </Card>
          <Card className="p-6 bg-[#F5F1E8] border-[#C9A86A]/30">
            ...
            <ul className="mt-3 text-sm space-y-1 list-disc pl-5">
              <li>Desayuno desde las 5am bajo reserva</li>
              <li>Guarda-equipaje hasta las 6pm sin costo</li>
              <li>Check-in flexible desde las 11am si vienes en bus nocturno</li>
