...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hotelquintasdebogota.com/hotel-cerca-corferias-gran-salon-ferretero-2026" },
  openGraph: {
    title: "Hotel Gran Salón Ferretero 2026 | Cerca Corferias",
    description: "Hotel a 7 min del Gran Salón Ferretero 2026. Guarda-equipaje amplio para herramientas, desayuno temprano.",
    url: "https://hotelquintasdebogota.com/hotel-cerca-corferias-gran-salon-ferretero-2026",
...
export default function GranSalonFerretero2026Page() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hotel Gran Salón Ferretero 2026", item: "https://hotelquintasdebogota.com/hotel-cerca-corferias-gran-salon-ferretero-2026" },
    ],
  };
  const eventJsonLd = {
    "@context": "https://schema.org",
