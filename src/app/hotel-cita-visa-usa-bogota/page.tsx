...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.hotelquintasdebogota.com/hotel-cita-visa-usa-bogota" },
  openGraph: {
    title: "Hotel para Cita Visa USA Bogotá | Reserva Directa",
    description: "Reserva directa sin comisión. 7 min de la Embajada. Cancelación 24h gratis.",
    url: "https://www.hotelquintasdebogota.com/hotel-cita-visa-usa-bogota",
...
export default function HotelCitaVisaUSA() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hotel Cita Visa USA", item: "https://www.hotelquintasdebogota.com/hotel-cita-visa-usa-bogota" },
    ],
  };
  const hotelJsonLd = {
    "@context": "https://schema.org",
